package kr.or.ddit.file.item02;
...
import kr.or.ddit.file.item02.service.ItemService2;
...
@Slf4j
public class FileUploadContoller02 {
	/*
	 	3. 여러 개의 이미지 업로드
	 	- 한 번에 여러 개의 이미지를 업로드하는 파일 업로드 기능을 구현한다.
	 		...
	 		1. 파일 업로드 구현 설명
	 			...
	 			- 파일 업로드 목록 화면 서비스 클래스 메소드 만드기
	 			- 파일 업로드 목록 화면 Mapper 인터페이스 메소드 만드기
